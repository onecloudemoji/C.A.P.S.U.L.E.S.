...
# Set IP Address
New-NetIPAddress -InterfaceAlias $interface -IPAddress 192.168.1.131 -PrefixLength 24 -DefaultGateway 192.168.1.1

# Set DNS Server
Set-DnsClientServerAddress -InterfaceAlias $interface -ServerAddresses 192.168.1.130

# Set Hostname
Rename-Computer -NewName "FILE01" -Force -Restart